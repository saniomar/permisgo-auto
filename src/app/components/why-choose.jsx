              ...
              <div id={whyChooseCss.choose_box} className="pt-4">
                <div className="row">
                  <div className="col-lg-3 col-md-6">
                    <div
                      className={`${whyChooseCss.about_choose_box} ${whyChooseCss.about_choose_box_one}`}
                    >
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div
                      className={`${whyChooseCss.about_choose_box} ${whyChooseCss.about_choose_box_two}`}
                    >
                      <div className={whyChooseCss.about_inner_box}>
                        <div className="text-center">
                          <Image
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div
                      className={`${whyChooseCss.about_choose_box} ${whyChooseCss.about_choose_box_three}`}
                    >
                      <div className={whyChooseCss.about_inner_box}>
                        <div className="text-center">
                          <Image
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div
                      className={`${whyChooseCss.about_choose_box} ${whyChooseCss.about_choose_box_four}`}
                    >
                      <div className={whyChooseCss.about_inner_box}>
                        <div className="text-center">
                          <Image
