            ...
            <div className="row">
              <div className="col-lg-2 col-md-6" id={footerStyle.column}>
                ...
                <div className={footerStyle.footer_contact}>
                  <ul>
                    ...
                    <li>
                      <GrLocation /> | Road no-2, Sector-6, Uttara, Dhaka,
                      Bangladesh
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="mt-3">
                    <div className="dropdown">
                      <button
                        ...
                        id={footerStyle.footerTimeDropDown}
                        type="button"
                      ...
                      <ul
                        ...
                        id={footerStyle.footerTimeDropDownItems}
                      >
              ...
              <div className="col-lg-2 col-md-6" id={footerStyle.column}>
                ...
                <div className={footerStyle.footer_menu}>
                  <ul>
                    ...
                    <li>
                      <Link href="/where-are-we">Where are we?</Link>
                    </li>
                    <li>
                      <Link href="/monitor-privacy-policy">
                        Monitor Privacy Policy
                      </Link>
                    </li>
                    <li>
                      <Link href="/student-privacy-policy">
                        Student Privacy Policy
                      </Link>
                    </li>
                    <li>
                      <Link href="/manage-my-cookies">Manage my cookies</Link>
                    </li>
                    <li>
              ...
              <div className="col-lg-2 col-md-6" id={footerStyle.column}>
                ...
                <div className={footerStyle.footer_partnership}>
                  <ul>
                    <li>
                      <Link href="/login-to-my-partner-area">
                        Log in to my partner area
                      </Link>
                    </li>
                    <li>
                      <Link href="/request-for-school-partnership">
                        Request for school partnership
                      </Link>
                    </li>
                    <li>
                      <Link href="/b2b-partnership-request">
                        B2B partnership request
                      </Link>
                    </li>
                    <li>
                      <Link href="/becoming-an-independent-instructor">
                        Becoming an independent instructor
                      </Link>
                    </li>
                    <li>
                      <Link href="/driving-instructor-salary">
                        Driving instructor salary
                      </Link>
                    </li>
                    <li>
                      <Link href="/monitor-faqs">Monitor FAQs</Link>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-2 col-md-6" id={footerStyle.column}>
                ...
                <div className={footerStyle.footer_services}>
                  <ul>
                    ...
                    <li>
                      <Link href="/highway-code-glossary">
                        Highway Code Glossary
                      </Link>
                    </li>
                    <li>
                      <Link href="/driving-licence-glossary">
                        Driving licence glossary
                      </Link>
                    </li>
                    <li>
                      <Link href="/person-with-a-disability">
          ...
          <div className="container">
            ...
            <div className="text-center">
              ...
              <p className="mb-0">
                ...
                & Development By :-{" "}
                <Link href="https://www.digitalmarketingbd.com/">
