          ...
          <div className="container-fluid">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div>
                {/* Outside Navigation */}
                <div
                  id={testimonialStyles.navigationIcon}
              ...
              >
                <SwiperSlide>
                  <div className={testimonialStyles.testimonialBox}>
                    <p className={testimonialStyles.testiSay}>
                      Thanks to the instructors, I passed my driving test on the
                      first try. The lessons were clear and very helpful! I
                      passed my driving test on the first try.
                    </p>
                    <ul>
                      <li>
                        <FaStar />
